import { BathIcon, BedIcon, HeartIcon, HouseIcon, StarIcon } from 'lucide-react'
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center mb-2">
            <StarIcon className="size-4 text-yellow-400 mr-1" />
        ...
        <div className="flex justify-between items-center gap-4 text-gray-600 mt-5">
          <span className="flex items-center">
            <BedIcon className="size-5 mr-2" />
            {property.beds} Bed
          </span>
          <span className="flex items-center">
            <BathIcon className="size-5 mr-2" />
            {property.baths} Bath
          </span>
          <span className="flex items-center">
